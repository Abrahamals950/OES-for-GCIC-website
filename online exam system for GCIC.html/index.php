...
<div class="jumbotron text-center">
  <h1>Online Examination System for Gessa Industrial&Construction Colege</h1> 
  <p>ኢንተርኔትን መሰረት ያደረገ የፈተና አሰጣጥ</p> 
  <!--  form>
...
<div id="services" class="container-fluid text-center">
  ...
  <div class="row slideanim">
    <div class="col-sm-4">
      ...
      <h4>	ኢንተርኔትን መሰረት ላደረገ የፈተና አሰጣጥ </h4>
      <p> Multiple users One platform</p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-euro logo-small"></span>
      <h4>	የፈተና ወጪዎችን ለመቀነስ/COST OPTIMISED</h4>
      <p>	የወረቀት  ስራዎችን ለመቀነስ/Reduces paper work</p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-user logo-small"></span>
      <h4>	ተጠቃሚዎችን ለማስደሰት/USER SATISFACTION</h4>
      <p>	የተጠቃሚዎች ደስታ የኔ ደስታ ነው..</p>
    </div>
  </div>
  <br><br>
  <div class="row slideanim">
    ...
    <div class="col-sm-4">
      ...
      <h4>CERTIFIED</h4>
      <p>Certified from GCIC..</p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-envelope logo-small"></span>
      <h4 style="color:#303030;">CONTACT Me on 0931351896</h4>
      <p>Contact me directly for help..</p>
    </div>
  </div>
</div>
  ...
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <h4>"Very good iniative. I am so happy with the result!"<br><span>በጣም ምርጥ እና ዘመን የዋጀ መሆኑ እና የተለያዩ በፈተና ላይ የምታዩ ችግሮችን በመፍታቱ በጣም ተደስተናል። የምሉትም ብዙሃን ናቸው</span></h4>
      </div>
      <div class="item">
        <h4>"One word... WOW!!"<br><span>John Doe, Salesman, Rep Inc</span></h4>
      </div>
      <div class="item">
        <h4>"Could I... BE any more happy with this startup"<br><span>all my friends and instructors  says</span></h4>
      </div>
    </div>
...
<div id="feedback" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      <h2>በዚህ ስራ ዙሪያ ላይ የምታየውን ዬትኛውንም ክፍተት እና አድናቆት ቀጣይ ባለው ሃሳብ መስጫ ሳጥን ላይ ብታስቀምጡልኝ በፍጥነት ምላሽ የምሰጣችሁ ይሆናል</h2>
